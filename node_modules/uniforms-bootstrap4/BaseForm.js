    ...
    return _temp = _class = function (_parent) {
        ...
        (0, _createClass3.default)(_class, [{
            ...
            value: function getChildContextState() {
                return (0, _extends3.default)({}, (0, _get3.default)(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'getChildContextState', this).call(this), {
            ...
            value: function getNativeFormProps() {
                ...
                var _get$call = (0, _get3.default)(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'getNativeFormProps', this).call(this),
                    ...
                    grid = _get$call.grid,
                    props = (0, _objectWithoutProperties3.default)(_get$call, ['className', 'grid']);

                return (0, _extends3.default)({}, props, {
                    className: (0, _classnames2.default)('form', { error: error }, className)
                });
            }
        }]);
        return _class;
    }(parent), _class.Bootstrap4 = Bootstrap4, _class.displayName = 'Bootstrap4' + parent.displayName, _class.propTypes = (0, _extends3.default)({}, parent.propTypes, {

        grid: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.object, _propTypes2.default.string])
    }), _temp;
};

exports.default = Bootstrap4(_BaseForm2.default);