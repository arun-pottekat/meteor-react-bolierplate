...
var ListDel = function ListDel(_ref) {
    var className = _ref.className,
        ...
        props = (0, _objectWithoutProperties3.default)(_ref, ['className', 'disabled', 'name', 'parent', 'removeIcon']);
...
ListDel.defaultProps = { removeIcon: _react2.default.createElement('i', { className: 'octicon octicon-dash' }) };
