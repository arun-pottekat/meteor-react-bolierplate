...
var renderSelect = function renderSelect(props) {
    return _react2.default.createElement(
        ...
        (!!props.placeholder || !props.required) && _react2.default.createElement(
            'option',
            { value: '', disabled: props.required, hidden: props.required },
...
var Select = function Select(props) {
    return (0, _wrapField2.default)(props, props.checkboxes || props.fieldType === Array ? renderCheckboxes(props) : renderSelect(props));
};
